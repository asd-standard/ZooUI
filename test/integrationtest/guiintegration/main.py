...
from guiintegration.test import (  # noqa: E402
    ...
    right_click_image,
    right_click_string,
    right_click_string_shift_enter,
    right_click_svg,
    right_click_svg_shift_enter,
    save_scene,
    save_screenshot,
    sensitivity_dialog,
    set_framerate,
...
class GUIIntegrationTest:
    ...
    def __init__(self):
        ...
        self.steps: list[tuple[int, str, Callable]] = [
            ...
            (39, "File Menu - Open new SVG (Ctrl+Enter Accept)", open_svg_shift_enter.run),
            ...
            (50, "Actions Menu - Set/Go to Home Point", home_point.run),
            (37, "Keyboard - Ctrl+C/V Copy Paste", keyboard_copy_paste.run),
            (47, "Mouse Right-Click - SVG Modification Dialog", right_click_svg.run),
            (49, "Mouse Right-Click - SVG Modification (Ctrl+Enter Accept)", right_click_svg_shift_enter.run),
