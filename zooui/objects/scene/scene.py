...
class Scene(PhysicalObject):
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        """
        New scene is made by initiating a :class:`~zooui.objects.physicalobject.PhysicalObject`,
        ...
        For better explaining of this scheme look at :  :class:`zooui.objects.mediaobjects.mediaobject`
    ...
    def remove(self, mediaobject: Union["MediaObject.MediaObject", list["MediaObject.MediaObject"]]) -> None:
        ...
        See: :meth:`zooui.tilesystem.tilemanager.purge`
    ...
    def get(
        ...
        *MediaObjects* that intersect the rectangle defined by these two points,
        ...
        Mouse click event is caught by: :meth:`zooui.qzui.QZUI.mousePressEvent`
    ...
    def render_order(self) -> str:
        ...
        See : :meth:`zooui.objects.scene.scene.Scene.set_render_order`
        """
    ...
    def set_render_order(self, mode: str) -> None:
        ...
        See : :meth:`zooui.objects.scene.scene.Scene.__sort_objects`
        """
    ...
    def __sort_objects(self) -> None:
        ...
        See :  :attr:`zooui.objects.mediaobjects.mediaobject.MediaObject.onscreen_area`
    ...
    def step(self, t: float) -> None:
        ...
        them call :meth:`zooui.objects.physicalobject.PhysicalObject.step` inherited method.
        """
    ...
    def vzmoving(self) -> bool:
        ...
        *MediaObjects* have a non-zero velocity.
        ...
        See : :class:`zooui.objects.physicalobject.PhysicalObject`
        """
        if self.vz != 0:
            return True
        else:
