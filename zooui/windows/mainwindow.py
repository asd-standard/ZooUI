...
class MainWindow(QtWidgets.QMainWindow):
    ...
    MainWindow windows are used for displaying the ZooUI interface.
    ...
    def __update_window_title(self) -> None:
        ...
        self.setWindowTitle(f"ZooUI — {title}")
    ...
    def __action_open_scene(self) -> None:
        ...
        """
        filename = str(
            QtWidgets.QFileDialog.getOpenFileName(self, "Open scene", self.__prev_dir, "ZooUI Scenes (*.pzs)")[0]
        )
    ...
    def __action_import_scene(self) -> None:
        ...
        """
        filename = str(
            QtWidgets.QFileDialog.getOpenFileName(self, "Import scene", self.__prev_dir, "ZooUI Scenes (*.pzs)")[0]
        )
    ...
    def __action_save_scene(self) -> None:
        ...
        filename = str(
            QtWidgets.QFileDialog.getSaveFileName(
                self, dialog_title, os.path.join(self.__prev_dir, default_name), "ZooUI Scenes (*.pzs)"
            )[0]
        )
    ...
    def __action_about(self) -> None:
        ...
        QtWidgets.QMessageBox.about(
            self,
            f"ZooUI {ZooUI.__version__}",
            ZooUI.__doc__ + "\n" + ZooUI.__copyright__ + "\n" + ZooUI.__copyright_notice__,
        )
