...
"""Manual tilestore cleanup utility for ZooUI.

This script allows you to manually clean up old tiles from the tilestore directory.
It can be run standalone without starting the full ZooUI application.
"""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="ZooUI Tilestore Cleanup Utility",
